...
class PokemonViewController: UIViewController {
    ...
    var random4Pokemons:[PokemonModel] = []{
        //Esta funcion se ejecuta cuando la variable es llenada
        didSet{
            //Inicializamos los titulos con los nombres de los pokemos ya obtenidos
            setButtonTitles()
        }
    }
    ...
    @IBAction func buttonPressed(_ sender: UIButton) {
        ...
        if game.checkAnswer(userAnswer, correctAnswer){
            labelMessage.text = "Sí, es un \(correctAnswer)"
...
//            labelMessage.text = "NOOO, es un \(correctAnswer)"
